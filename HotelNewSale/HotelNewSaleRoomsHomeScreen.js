            ...
            <View style={globalstyles.form}>
                <View style={{ marginTop:20 }}>
                    ...
                    < View style={globalstyles.input}>
                        ...
                        <TextInput style={globalstyles.textInput}  placeholder='Customer Full Name' />
                    </View>
                </View>
                ...
                <View  style={{ marginTop:20 }}>
                    ...
                    < View style={globalstyles.input}>
                        ...
                        <TextInput style={globalstyles.textInput}  placeholder='Phone Number' />
                    </View>
                </View>
                ...
                <View  style={{ marginTop:20 }}>
                    ...
                    < View style={globalstyles.input}>
                        <FontAwesome style={globalstyles.icon} name='plus-circle'/>
                        <TextInput style={globalstyles.textInput}  placeholder='Customer Address' />
                    </View>
                </View>
               ...
               <View  style={{ marginTop:20 }}>
                    ...
                    < View style={globalstyles.input}>
                        <FontAwesome style={globalstyles.icon} name='plus-circle'/>
                        <TextInput style={globalstyles.textInput}  placeholder='Number of Days' />
                    </View>
                </View>
