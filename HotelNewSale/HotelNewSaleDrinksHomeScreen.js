...
const HotelNewSaleDrinksHomeScreen =({navigation }) => {
...
const AddDrink =() =>{
 ...
 //FOR APIS
//const { services:food, isPending, error } = useFetch(MyDomain+'/apis/HotelFood/');
...
<MinorHeader title="Drinks" pressMe={AddDrink} screenName="Hotel NewSale" />
...
export default HotelNewSaleDrinksHomeScreen;
