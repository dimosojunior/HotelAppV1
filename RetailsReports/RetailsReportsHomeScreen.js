...
import RetailsReportComponent from '../RenderedComponents/RetailsReportComponent';
...
const AddReport =() =>{
  ...
  return (
    ...
    <MinorHeader title="Reports" pressMe={AddReport} screenName="Retails Category" />
      <KeyboardAvoidingView
